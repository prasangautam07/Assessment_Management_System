...
export const PersonalInformationForm = ({setFormFilled}) => {
    const handleSubmit = (e) => {
        e.preventDefault();
        setFormFilled(true);        
    };
  return (
     <div className='flex flex-col container bg-white card-shadow max-w-3xl items-center justify-center gap-4'>
        <div>
          <h1 className='font-bold text-2xl mb-1'>Hello</h1>
